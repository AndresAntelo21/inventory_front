...
export const SidebarItem: React.FC<SidebarItemProps> = ({ icon, text, href }) => {
    return (
        <a
            href={href}
            className="pl-2 text-2xl flex gap-3 py-1 items-center hover:bg-blue-950/60 hover:rounded-r-lg transition-all duration-300 ease-in-out text-white/80 hover:text-white"
        >
